...
export const SECCIONES_GESTION: SeccionConfig[] = [
  ...
  },
  {
    ...
    id: 'orfeo',
    label: 'Orfeo',
    descripcion: 'Radicados de Orfeo: solicitud y respuesta.',
    obligatoria: true,
    tabla: 'gestion_documental',
    colorClasses: {
    ...
    grupos: [
      {
        titulo: 'Documentos Orfeo',
        campos: [
          { id: 'ORFEO_SOLICITUD',   label: 'Orfeo solicitud',   requeridoPorDefecto: true },
          { id: 'ORFEO_RESPUESTA',   label: 'Orfeo respuesta',   requeridoPorDefecto: true },
        ],
      },
    ],
  },
